...
(function() {
  ...
  $.awesomeCropper = function(inputAttachTo, options) {
    ...
    $imagesContainer = div().append(div().addClass('modal-body row-fluid').append(div().addClass('span7').append($sourceIm)).append(div().addClass('span5').append($cropSandbox)), div().addClass('modal-footer').append($applyButton).append($cancelButton)).append().addClass('modal hide fade').attr({
      role: 'dialog'
    });
